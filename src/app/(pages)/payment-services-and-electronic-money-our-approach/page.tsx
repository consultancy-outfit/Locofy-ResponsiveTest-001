...
import { paymentService1, paymentService10, paymentService11, paymentService12, paymentService13, paymentService14, paymentService15, paymentService16, paymentService17, paymentService18, paymentService19, paymentService2, paymentService20, paymentService21, paymentService3, paymentService4, paymentService5, paymentService6, paymentService7, paymentService8, paymentService9 } from "@/assets";
...
const PaymentServicePageData = [
    ...
    },
    {
        ...
        title: "Ch 16: Payment service providers’ access to payment account services",
    },
    {
        key: "e-17",
        link: "/chapter-17-ayment-initiation-ais-and-confirmation-of-availability-of-funds",
        icon: paymentService17,
        title: "Ch 17: Payment initiation and account information servicesand confirmation of availability of funds",
    },
    {
        key: "e-18",
