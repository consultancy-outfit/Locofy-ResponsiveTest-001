...
const PeriodicTable: React.FC<PeriodicTableProps> = ({ cell, colIndex }) => {
      ...
      <div>
        ...
        <div
          style={{
            width: "100%",
            maxWidth: "100px",
            borderRadius: "10.062px 0 0 0",
            color: "#fff",
            background: cell.background ? tileColors[cell.background] : undefined,
            padding: 0.3,
            textAlign: "center",
          }}
        >
        ...
        <div style={{ padding: 20 }}>
          {cell.image && cell.code && (
            <Image src={cell.image} alt="logo" width={41} height={41} />
          )}
          {cell.name && (
  ...
  const isLink = typeof cell.link === "string" && cell.link.trim() !== "";
  ...
  return (
    ...
    >
      {isLink ? (
        <Link href={cell.link} style={{ display: "block", textDecoration: "none", color: "inherit" }}>
          {renderContent()}
        </Link>
      ) : (
        renderContent()
